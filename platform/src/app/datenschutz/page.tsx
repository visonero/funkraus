...
Wir setzen technisch notwendige Cookies ein, die für den Betrieb der Website und insbesondere für die Anmeldung und den sicheren Zugriff auf Ihr Nutzerkonto erforderlich sind (Session-/Authentifizierungs-Cookies unseres technischen Dienstleisters Supabase, z. B. mit einem Namen nach dem Muster „sb-\\<projekt\\>-auth-token"). Rechtsgrundlage ist § 25 Abs. 2 Nr. 2 TTDSG i. V. m. Art. 6 Abs. 1 lit. b DSGVO, da diese Cookies zur Erbringung des von Ihnen ausdrücklich gewünschten Dienstes (Login, Kursnutzung) unbedingt erforderlich sind. Eine Einwilligung ist für diese technisch notwendigen Cookies nicht erforderlich.

Wir setzen derzeit **keine** Analyse-, Marketing- oder Tracking-Cookies und keine vergleichbaren Technologien Dritter ein.
...
## 7. Hosting und Datenbank (Supabase)
